...
extern double Entry_Amount    = 0.01; // Amount for a new position [lot]
extern double Maximum_Amount  = 20; // Maximum position amount [lot]
extern double Adding_Amount   = 0.02; // Amount to add on addition [lot]
extern double Reducing_Amount = 0.01; // Amount to close on reduction [lot]
...
Strategy *StrategyManager::GetStrategy(void)
{
   ...
   Strategy *strategy = new Strategy(0, 1);

   strategy.StrategyName           = "New Strategy";
   ...
   strategy.AddingLots             = 0.02;
   strategy.ReducingLots           = 0.01;
   strategy.UseMartingale          = true;
   strategy.MartingaleMultiplier   = 0.4;
   strategy.Description            = "Exported on 2/12/2017 from Forex Strategy Builder Professional, v3.4.1";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 72;
   strategy.MinBarsRequired        = 73;
   strategy.PermanentSL            = 50;
   strategy.UsePermanentSL         = true;
   strategy.PermanentSLType        = PermanentProtectionType_Relative;
   strategy.PermanentTP            = 50;
   strategy.UsePermanentTP         = true;
   strategy.PermanentTPType        = PermanentProtectionType_Relative;
   strategy.BreakEven              = 30;
   ...
   strategy.Slot[1].IndicatorName    = "Bar Closing";
   strategy.Slot[1].SlotType         = SlotTypes_Close;
   ...
   strategy.Slot[1].LogicalGroup     = "";
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("Bar Closing", SlotTypes_Close);
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "Exit the market at the end of the bar";
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[1].Text    = "Close";

   strategy.Slot[2].IndicatorName    = "Moving Average";
   strategy.Slot[2].SlotType         = SlotTypes_CloseFilter;
   ...
   strategy.Slot[2].IndicatorPointer = indicatorManager.CreateIndicator("Moving Average", SlotTypes_CloseFilter);
   ...
   strategy.Slot[2].IndicatorPointer.CheckParam[0].Checked = false;
